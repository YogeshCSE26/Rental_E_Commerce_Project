...
// Calling Main Function Mongoose connection setup
main()
    .then(() => {
...
// Connecting with MongoDB database Created with function
async function main() {
...
const initDB = async () => {
    ...
    //     ...obj, 
    //     owner: "6a0eaea966fb561ac6d22ea8",
    //     geometry: {
    //         type: "Point",
    //         coordinates: [77.2090, 28.6139] // New Delhi's default coordinates for old data
    //     }
    // }));

    // // Now, inserting own manual data file
    ...
    try {
        ...
        for (let obj of initData.data) {
            ...
            updatedData.push({
                ...obj,
                owner: "6a2eca820e3e449b9a58451a", // user ID
                geometry: {
                    type: "Point",
                    coordinates: coords
                }
